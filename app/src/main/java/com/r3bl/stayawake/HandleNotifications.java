...
@NonNull private static String getNotificationContent(Service context) {
  return context.getString(R.string.notification_text_content);
}

@NonNull private static String getNotificationTitle(Service context) {
...
@NonNull private static String getNotificationStopActionText(Service context) {
